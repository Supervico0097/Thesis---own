...
class SyntheticStreamingDataGenerator:
    def __init__(self, config_file_path):
        ...
        self.config.users_rate = self.config.users_rate
        self.config.artists_rate = self.config.artists_rate
    ...
    def create_users(self, week_no):
        num_users_to_add = round(
            ...
            * (self.config.users_rate / 5976.23302825)
        )
    ...
    def create_artists(self, week_no):
        num_artists_to_add = round(
            (11.17315 + 0.3660266 * week_no + 0.009279995 * week_no ** 2)
            * (self.config.artists_rate / 5976.23302825)
        )
    ...
    def generate_streams(self, week_no):
        ...
        assert (
            self.user_list
        ), "user_list is empty. Increase rate of Users"  # It checks whether the list is empty
        premium_songs = [
